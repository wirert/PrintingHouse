...
namespace PrintingHouse.Infrastructure.Migrations
{
    ...
    [Migration("20230630160250_FirstAndLastNameNullableAndRemoveEnumerationFromConsumablesAndMaterialsTypes")]
    partial class FirstAndLastNameNullableAndRemoveEnumerationFromConsumablesAndMaterialsTypes
    {
            ...
            modelBuilder.Entity("PrintingHouse.Infrastructure.Data.Entities.Article", b =>
                {
                    ...
                    b.Property<string>("DesignUrl")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasComment("Url to design image");
